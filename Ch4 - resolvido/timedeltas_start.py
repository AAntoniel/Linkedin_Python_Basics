...
print("In four weeks and 5 days it will be", str(now + timedelta(weeks=4, days=5)))
print("In 60 minutes and 5 days it will be", str(now + timedelta(minutes=60, days=5)))
...
print("It is", time_to_afd.days, "Until the next April")